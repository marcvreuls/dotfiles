...
def install_homebrew
  ...
  puts "======================================================"
  run %{brew install zsh ctags git mercurial hub tmux reattach-to-user-namespace the_silver_searcher brew-cask python mysql libjpeg wget jmeter docker boot2docker siege}
